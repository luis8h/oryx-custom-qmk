...
#define DUAL_FUNC_4 LT(6, KC_T)
#define DUAL_FUNC_5 LT(13, KC_N)
#define DUAL_FUNC_6 LT(12, KC_K)
#define DUAL_FUNC_7 LT(3, KC_F)
#define DUAL_FUNC_8 LT(5, KC_F10)
#define DUAL_FUNC_9 LT(8, KC_5)
#define DUAL_FUNC_10 LT(4, KC_V)
#define DUAL_FUNC_11 LT(6, KC_F21)
#define DUAL_FUNC_12 LT(10, KC_2)
#define DUAL_FUNC_13 LT(4, KC_F11)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, LT(8, KC_MINUS),MT(MOD_LGUI, KC_QUOTE),DUAL_FUNC_1,    DUAL_FUNC_2,    KC_GRAVE,       KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_PLUS,        MT(MOD_LCTL, KC_SLASH),DUAL_FUNC_7,    DUAL_FUNC_8,    MT(MOD_LALT, KC_SCLN),KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_DOT,         KC_1,           KC_2,           KC_3,           KC_COMMA,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_CIRC,        DUAL_FUNC_10,   KC_LPRN,        DUAL_FUNC_6,    KC_ASTR,        KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, DUAL_FUNC_9,    LT(3, KC_7),    KC_8,           MT(MOD_RALT, KC_9),KC_EQUAL,                                       KC_TRANSPARENT, DUAL_FUNC_13,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_4,    KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, MT(MOD_LGUI, KC_MINUS),MT(MOD_LGUI, KC_4),MT(MOD_LSFT, KC_5),MT(MOD_LCTL, KC_6),KC_0,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_PLUS,        MT(MOD_LCTL, KC_SLASH),DUAL_FUNC_11,   DUAL_FUNC_12,   KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, DUAL_FUNC_9,    KC_7,           KC_8,           MT(MOD_RALT, KC_9),KC_EQUAL,                                       KC_TRANSPARENT, KC_TRANSPARENT, KC_COMMA,       KC_DOT,         KC_TRANSPARENT, KC_TRANSPARENT, 
