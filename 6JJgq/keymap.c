...
#define DUAL_FUNC_1 LT(5, KC_Q)
#define DUAL_FUNC_2 LT(4, KC_X)
#define DUAL_FUNC_3 LT(4, KC_U)
#define DUAL_FUNC_4 LT(3, KC_F8)
#define DUAL_FUNC_5 LT(4, KC_1)
#define DUAL_FUNC_6 LT(7, KC_F3)
#define DUAL_FUNC_7 LT(11, KC_W)
#define DUAL_FUNC_8 LT(6, KC_F16)
#define DUAL_FUNC_9 LT(7, KC_7)
#define DUAL_FUNC_10 LT(14, KC_F16)
#define DUAL_FUNC_11 LT(2, KC_5)
#define DUAL_FUNC_12 LT(14, KC_S)
#define DUAL_FUNC_13 LT(7, KC_F19)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_DOT,         KC_1,           KC_2,           KC_3,           KC_COMMA,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_CIRC,        DUAL_FUNC_10,   KC_LPRN,        DUAL_FUNC_7,    KC_ASTR,        KC_TRANSPARENT,
    KC_TRANSPARENT, MT(MOD_LGUI, KC_MINUS),MT(MOD_LGUI, KC_4),MT(MOD_LSFT, KC_5),MT(MOD_LCTL, KC_6),KC_0,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_PLUS,        MT(MOD_LCTL, KC_SLASH),DUAL_FUNC_11,   DUAL_FUNC_12,   KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, DUAL_FUNC_3,    LT(3, KC_7),    KC_8,           MT(MOD_RALT, KC_9),KC_EQUAL,                                       KC_TRANSPARENT, DUAL_FUNC_13,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_5,    KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
