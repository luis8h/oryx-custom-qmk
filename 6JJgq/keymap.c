...
#define DUAL_FUNC_2 LT(12, KC_F13)
#define DUAL_FUNC_3 LT(13, KC_F9)
#define DUAL_FUNC_4 LT(7, KC_F17)
#define DUAL_FUNC_5 LT(14, KC_F12)
#define DUAL_FUNC_6 LT(7, KC_J)
#define DUAL_FUNC_7 LT(3, KC_F8)
#define DUAL_FUNC_8 LT(15, KC_F21)
#define DUAL_FUNC_9 LT(4, KC_F8)
#define DUAL_FUNC_10 LT(3, KC_N)
#define DUAL_FUNC_11 LT(14, KC_S)
#define DUAL_FUNC_12 LT(3, KC_C)
#define DUAL_FUNC_13 LT(7, KC_F23)
#define DUAL_FUNC_14 LT(11, KC_F24)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_LALT, KC_Q),KC_W,           KC_F,           KC_P,           ALL_T(KC_B),    KC_TRANSPARENT,                                 KC_TRANSPARENT, ALL_T(KC_J),    LT(6, KC_L),    LT(9, KC_U),    LT(5, KC_Y),    KC_LEFT_ALT,    KC_TRANSPARENT, 
    KC_TRANSPARENT, LT(8, KC_A),    MT(MOD_LGUI, KC_R),MT(MOD_LSFT, KC_S),MT(MOD_LCTL, KC_T),KC_G,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_M,           MT(MOD_LCTL, KC_N),MT(MOD_RSFT, KC_E),MT(MOD_LGUI, KC_I),LT(8, KC_O),    KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_Z,           LT(3, KC_X),    KC_C,           MT(MOD_RALT, KC_D),KC_V,                                           KC_K,           MT(MOD_RALT, KC_H),KC_COMMA,       LT(3, KC_DOT),  OSL(2),         KC_TRANSPARENT, 
  ...
  [1] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, DUAL_FUNC_0,    KC_AT,          KC_HASH,        KC_DLR,         KC_PERC,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_CIRC,        DUAL_FUNC_5,    KC_LPRN,        DUAL_FUNC_6,    DUAL_FUNC_7,    KC_TRANSPARENT, 
    KC_TRANSPARENT, LT(8, KC_MINUS),MT(MOD_LGUI, KC_QUOTE),DUAL_FUNC_1,    DUAL_FUNC_2,    KC_GRAVE,       KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_PLUS,        MT(MOD_LCTL, KC_SLASH),DUAL_FUNC_8,    DUAL_FUNC_9,    LT(8, KC_SCLN), KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_UNDS,        DUAL_FUNC_3,    KC_LBRC,        MT(MOD_RALT, KC_RBRC),KC_EQUAL,                                       KC_TILD,        MT(MOD_RALT, KC_BSLS),KC_TRANSPARENT, KC_TRANSPARENT, TO(2),          KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_DOT,         KC_1,           KC_2,           KC_3,           KC_COMMA,       KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_CIRC,        DUAL_FUNC_11,   KC_LPRN,        DUAL_FUNC_6,    KC_ASTR,        KC_TRANSPARENT, 
    KC_TRANSPARENT, MT(MOD_LGUI, KC_MINUS),MT(MOD_LGUI, KC_4),MT(MOD_LSFT, KC_5),MT(MOD_LCTL, KC_6),KC_0,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_PLUS,        MT(MOD_LCTL, KC_SLASH),DUAL_FUNC_12,   DUAL_FUNC_13,   KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, DUAL_FUNC_10,   LT(3, KC_7),    KC_8,           MT(MOD_RALT, KC_9),KC_EQUAL,                                       KC_TRANSPARENT, DUAL_FUNC_14,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DUAL_FUNC_4,    KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, MT(MOD_LGUI, KC_MINUS),MT(MOD_LGUI, KC_4),MT(MOD_LSFT, KC_5),MT(MOD_LCTL, KC_6),KC_0,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_PLUS,        MT(MOD_LCTL, KC_SLASH),DUAL_FUNC_12,   DUAL_FUNC_13,   KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, DUAL_FUNC_10,   KC_7,           KC_8,           MT(MOD_RALT, KC_9),KC_EQUAL,                                       KC_TRANSPARENT, KC_TRANSPARENT, KC_COMMA,       KC_DOT,         KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [8] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_UP,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_HOME,        KC_TRANSPARENT, KC_END,         MT(MOD_LALT, KC_UP),KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, MT(MOD_LGUI, KC_LEFT),MT(MOD_LSFT, KC_DOWN),MT(MOD_LCTL, KC_RIGHT),KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_LEFT,        MT(MOD_LCTL, KC_DOWN),MT(MOD_LSFT, KC_UP),MT(MOD_LGUI, KC_RIGHT),KC_TRANSPARENT, KC_TRANSPARENT, 
